...
# for position in five six seven eight;
# do
#     for length in simple long
#         do
#             echo -n "msm_ten_nodes_mim_${position}_${length},"  >> "$output_file"
#             ./quisp -u Cmdenv simulations/heterogeneous.ini -c msm_ten_nodes_mim_${position}_${length}
#             echo >> "$output_file"
#     done
# done

for position in six seven eight;
do
    for length in simple long
        do
            echo -n "msm_ten_nodes_mim_${position}_${length}_adaptive," >> "$output_file"
