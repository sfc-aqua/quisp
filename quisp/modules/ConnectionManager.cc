...
void ConnectionManager::initialize() {
  EV_DEBUG << "ConnectionManager booted\n";
  routingdaemon = check_and_cast<RoutingDaemon *>(getParentModule()->getSubmodule("rd"));
  hardwaremonitor = check_and_cast<HardwareMonitor *>(getParentModule()->getSubmodule("hm"));
