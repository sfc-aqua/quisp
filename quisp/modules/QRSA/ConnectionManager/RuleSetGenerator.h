...
class RuleSetGenerator {
 public:
   ...
   */
  std::map<int, nlohmann::json> generateRuleSets(messages::ConnectionSetupRequest* req, unsigned long ruleset_id, std::vector<std::string> ruleset_path);

  /**
   * @brief load RuleSets generated by RuLa
   *
   * @param ruleset_path
