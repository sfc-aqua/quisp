...
void HardwareMonitor::finish() {
  ...
  for (auto it = qnic_partner_map.begin(); it != qnic_partner_map.end(); it++) {
    ...
    EV << this_node->getFullName() << "<-->QuantumChannel{cost=" << link_cost << ";distance=" << dis << "km;fidelity=" << fidelity
...
std::unique_ptr<Rule> HardwareMonitor::constructPurifyRule(const std::string &rule_name, const rules::PurType pur_type, const int partner_address, const QNIC_type qnic_type,
  ...
  switch (pur_type) {
    case PurType::SINGLE_SELECTION_X_PURIFICATION:
    case PurType::SINGLE_SELECTION_Z_PURIFICATION:
    case PurType::SINGLE_SELECTION_Y_PURIFICATION:
      required_qubits = 2;
      break;
    case PurType::SINGLE_SELECTION_XZ_PURIFICATION:
    case PurType::SINGLE_SELECTION_ZX_PURIFICATION:
    case PurType::DOUBLE_SELECTION_X_PURIFICATION:
    case PurType::DOUBLE_SELECTION_Z_PURIFICATION:
      required_qubits = 3;
      break;
    case PurType::DOUBLE_SELECTION_XZ_PURIFICATION:
    case PurType::DOUBLE_SELECTION_ZX_PURIFICATION:
      required_qubits = 5;
      break;
    case PurType::DOUBLE_SELECTION_X_PURIFICATION_SINGLE_SELECTION_Z_PURIFICATION:
    case PurType::DOUBLE_SELECTION_Z_PURIFICATION_SINGLE_SELECTION_X_PURIFICATION:
      required_qubits = 4;
      break;
