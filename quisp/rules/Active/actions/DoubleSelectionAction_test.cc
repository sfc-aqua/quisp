...
using OriginalDoubleSelectionAction = quisp::rules::actions::DoubleSelectionAction;
...
class DoubleSelectionAction : public OriginalDoubleSelectionAction {
 public:
  ...
  static std::unique_ptr<DoubleSelectionAction> setupAction() {
    ...
    return std::make_unique<DoubleSelectionAction>(ruleset_id, rule_id, partner_addr, qnic_type, qnic_id, resource_index, trash_resource_x, trash_resource_z);
  }
...
TEST(DoubleSelectionActionTest, Init) {
  ...
  auto *action = new DoubleSelectionAction(ruleset_id, rule_id, partner_addr, qnic_type, qnic_id, resource_index, trash_resource_x, trash_resource_z);
