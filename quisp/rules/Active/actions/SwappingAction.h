...
class SwappingAction : public ActiveAction {
 public:
  SwappingAction(unsigned long ruleset_id, int rule_id, int shared_tag, int left_partner, QNIC_type left_qnic_type, int left_qnic_id, int left_qnic_address, int left_resource,
