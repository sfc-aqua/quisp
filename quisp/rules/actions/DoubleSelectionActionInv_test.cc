...
using OriginalDoubleSelectionActionInv = quisp::rules::actions::DoubleSelectionActionInv;
...
class DoubleSelectionActionInv : public OriginalDoubleSelectionActionInv {
 public:
  ...
  static std::unique_ptr<DoubleSelectionActionInv> setupAction() {
    ...
    return std::make_unique<DoubleSelectionActionInv>(ruleset_id, rule_id, partner_addr, qnic_type, qnic_id, resource_index, trash_resource_x, trash_resource_z);
  }
...
TEST(DoubleSelectionActionInvTest, Init) {
  ...
  auto *action = new DoubleSelectionActionInv(ruleset_id, rule_id, partner_addr, qnic_type, qnic_id, resource_index, trash_resource_x, trash_resource_z);
