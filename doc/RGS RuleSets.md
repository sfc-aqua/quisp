...
We assume that the physical qubits encoding a logical qubits arrive level-by-level (breadth first), that is qubits of Level 1 arrive one-by-one, then qubits of Level 2 and so.
